...
const UserAddEvent = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50 p-6 flex justify-center items-center">
      <div className="w-full max-w-2xl bg-white rounded-xl shadow-xl p-8">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data" className="space-y-4">
          ...
          <div>
            <label className="block font-medium mb-1 text-gray-700">Max Attendees <span className="text-gray-400 text-xs ml-1">(Leave empty for Free for All)</span></label>
            <input
              type="number"
              min={1}
              name="maxAttendees"
          ...
          <button
            type="submit"
            className="mt-4 w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold py-2 rounded shadow-lg hover:from-orange-600 hover:to-orange-700 transition"
          >
            Submit Event
          </button>
        </form>
